        ...
        <li v-for="(landmark, index) in filteredLandmarks" :key="landmark.landmark.landmarkId">
          <div class="landmark-item">
            <div class="landmark-info">
              ...
              <svg @click="clickForLike(false, index)" :fill="landmark.dislikeColor || 'currentColor'" class="bi bi-hand-thumbs-down dislike" viewBox="0 0 16 16">
              ...
              <svg @click="clickForLike(true, index)" :fill="landmark.likeColor || 'currentColor'" class="bi bi-hand-thumbs-up like" viewBox="0 0 16 16">
              ...
              <div>
                <p v-for="rating in filteredRatings(landmark.landmark.landmarkId)" :key="rating.landmarkId">thumbs_up: {{ rating.thumbs_up }}</p>
                <p v-for="rating in filteredRatings(landmark.landmark.landmarkId)" :key="rating.landmarkId">thumbs_down: {{ rating.thumbs_down }}</p>
              </div>
...
export default {
  ...
  filteredRatings(landmarkId) {
    ...
    clickForLike(isThumbsUp, index) {
      if (isThumbsUp) {
      
        this.filteredLandmarks[index].likeColor = this.filteredLandmarks[index].likeColor === "red" ? "" : "red";
        
        this.filteredLandmarks[index].dislikeColor = "";
      } else {

        this.filteredLandmarks[index].dislikeColor = this.filteredLandmarks[index].dislikeColor === "green" ? "" : "green";
