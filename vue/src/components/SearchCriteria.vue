...
export default {
  ...
  methods: {
    clickForLike(isThumbsUp, index) {
      if (isThumbsUp) {
        // Toggle color for thumbs up icon
        this.filteredLandmarks[index].likeColor = this.filteredLandmarks[index].likeColor === "green" ? "" : "green";
        // Reset color for thumbs down icon
        this.filteredLandmarks[index].dislikeColor = "";
      } else {
        // Toggle color for thumbs down icon
        this.filteredLandmarks[index].dislikeColor = this.filteredLandmarks[index].dislikeColor === "red" ? "" : "red";
        // Reset color for thumbs up icon
